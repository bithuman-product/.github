...
| Use the Python SDK | [PyPI: `bithuman`](https://pypi.org/project/bithuman/) | `pip install bithuman`. Source is private (signing material is baked in); file issues at [bithuman-examples](https://github.com/bithuman-product/bithuman-examples/issues). |
...
- **Issues / questions**: file in the repo closest to the problem. For PyPI / Python SDK issues, use [bithuman-examples/issues](https://github.com/bithuman-product/bithuman-examples/issues) (the SDK source is private).
